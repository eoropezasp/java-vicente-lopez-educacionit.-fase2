...
public class Buscador {
	...
	public void buscar() {
		...
		Resultado res1 = new Libros("MARVEL STUDIOS EL DICCION...", "https:bla.com.ar/img1.jpg", 13973.25f, "BRAY, ADAM","editorial Lora",23,"ingles");
		Resultado res2 = new Musica("NUNCA CORRI SIEMPRE COBRE", "https:bla.com.ar/img2.jpg", 6999, "OYOLA, LEONARDO A.","sony",343,"rock");
		Resultado res3 = new Peliculas("MARVEL: GUIA DE PERSONAJES I R", "https:bla.com.ar/img3.jpg", 9490, "CATAPULTA, LOS EDITORES DE","gloria","dvd");
